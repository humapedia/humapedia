...
const navigation = {
  ...
  social: [
    {
      name: 'GitHub',
      href: 'https://github.com/your-username/humapedia',
      icon: (props: any) => (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/humapedia',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'Discord',
      href: 'https://discord.gg/humapedia',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 flex items-center justify-center space-x-2 text-sm leading-5 text-gray-500 dark:text-gray-400">
          <span>Made with</span>
          <HeartIcon className="h-4 w-4 text-red-500" />
          <span>by the Humapedia Team</span>
        </div>
        
        <p className="mt-6 text-center text-xs leading-5 text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Humapedia. All rights reserved.
        </p>
        ...
        <div className="mt-6 flex justify-center space-x-6 text-xs text-gray-500 dark:text-gray-400">
          ...
          <Link href="/cookies" className="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
            Cookie Policy
          </Link>
        </div>
      </div>
